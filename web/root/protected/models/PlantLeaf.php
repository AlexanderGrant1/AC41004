...
/**
 * This is the model class for table "potato_PlantLeaf".
 *
 * The followings are the available columns in table 'potato_PlantLeaf':
 * @property integer $Id
...
class PlantLeaf extends CActiveRecord
{
	 ...
	 * @return PlantLeaf the static model class
	 */
